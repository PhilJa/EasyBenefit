<footer>
  <div class="top">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 hidde-md hidden-lg">
          ...
          <div id="mc_embed_signup">
            <form action="//easybenefit.us12.list-manage.com/subscribe/post?u=dac502ff20486257a18df4a18&amp;id=cdbacf2486" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
              <div id="mc_embed_signup_scroll">
                ...
                <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_dac502ff20486257a18df4a18_cdbacf2486" tabindex="-1" value=""></div>
                <div class="clear"><input type="submit" value="Anmelden" name="subscribe" id="mc-embedded-subscribe" class="btn btn-white"></div>
              </div>
            </form>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 left">
          <p>© <?php echo date("Y") ?> EasyBenefit gemeinnützige UG (haftungsbeschränkt)</p>
        </div>
        <div class="col-md-6 right">
          <p>EasyBenefit.de | Online einkaufen & Gutes tun.</p>
        </div>
      </div>
    </div>
  </div>
