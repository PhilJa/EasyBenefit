...
<body>
  ...
  <section id="hero" class="nopadding">
    ...
    <div class="container">
      <div class="hero-content">
        <h1>Schenken & Spenden</h1>
        <p>Weihnachtsgeschenke kaufen und kostenlos Geld spenden!</p>
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /section -->
  ...
  <section id="funktion-txt">
    <div class="container">
      <h2 style="text-align:center;font-weight:bold;"><span style="color:#336ba8">Spende kostenlos</span>, mit jedem Weihnachtsgeschenk</h2>
      <div class="row">
        <div class="col-md-8">
