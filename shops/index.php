...
<html lang="de">
<head>
    <title>Shops | EasyBenefit.de</title>
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalelbenwald">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/008.jpg"/>
                </div>
                <div class="shop-description">
                  10 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalkarstadt">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/009.png"/>
                </div>
                <div class="shop-description">
                  4 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalbodyshop">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/010.jpg"/>
                </div>
                <div class="shop-description">
                  12 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalgymaesthetics">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/012.jpg"/>
                </div>
                <div class="shop-description">
                  8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalfotopuzzle">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/014.png"/>
                </div>
                <div class="shop-description">
                  12 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalbelsonno">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/015.jpg"/>
                </div>
                <div class="shop-description">
                  10 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalplanetsports">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/017.png"/>
                </div>
                <div class="shop-description">
                  5-10 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalhome24">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/018.png"/>
                </div>
                <div class="shop-description">
                  4-8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modaltechnomarkt">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/019.png"/>
                </div>
                <div class="shop-description">
                  1,5 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalbergfreunde">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/020.png"/>
                </div>
                <div class="shop-description">
                  7 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalchrist">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/021.png"/>
                </div>
                <div class="shop-description">
                  8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalbrands4friends">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/022.png"/>
                </div>
                <div class="shop-description">
                  4-8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalceweprint">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/023.png"/>
                </div>
                <div class="shop-description">
                  3-18 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modaldecathlon">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/024.png"/>
                </div>
                <div class="shop-description">
                  6 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalreichelt">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/025.png"/>
                </div>
                <div class="shop-description">
                  5 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalschmuckonline">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/026.png"/>
                </div>
                <div class="shop-description">
                  8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalshopapotheke">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/027.png"/>
                </div>
                <div class="shop-description">
                  2,5-12 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalsportida">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/028.png"/>
                </div>
                <div class="shop-description">
                  2-11 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalvistaprint">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/029.png"/>
                </div>
                <div class="shop-description">
                  2-8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalzooplus">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/030.png"/>
                </div>
                <div class="shop-description">
                  4 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalbaudible">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/031.png"/>
                </div>
                <div class="shop-description">
                  12 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalorsay">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/032.png"/>
                </div>
                <div class="shop-description">
                  8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalshirtinator">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/033.png"/>
                </div>
                <div class="shop-description">
                  3,50-5,50 €
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalhunkemöller">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/035.png"/>
                </div>
                <div class="shop-description">
                  6 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalspartoo">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/036.png"/>
                </div>
                <div class="shop-description">
                  3 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalsidestep">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/037.png"/>
                </div>
                <div class="shop-description">
                  8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalseidensticker">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/038.png"/>
                </div>
                <div class="shop-description">
                  7 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalbokolina">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/041.png"/>
                </div>
                <div class="shop-description">
                  4,2 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalikea">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/042.png"/>
                </div>
                <div class="shop-description">
                  10 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalburoshop24">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/043.png"/>
                </div>
                <div class="shop-description">
                  5 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalroller">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/045.gif"/>
                </div>
                <div class="shop-description">
                  7 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalpostbus">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/047.jpg"/>
                </div>
                <div class="shop-description">
                  5 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalcomdirect">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/048.png"/>
                </div>
                <div class="shop-description">
                  2,50-60 €
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalholidaycheck">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/049.png"/>
                </div>
                <div class="shop-description">
                  6-50 €
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalengelhorn">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/050.png"/>
                </div>
                <div class="shop-description">
                  8 %
                </div>
          ...
          <div class="col-md-2 col-sm-3 col-xs-4 smallerpadding">
            <a data-toggle="modal" data-target="#modalschalke04">
              <div class="shopcard">
                <div class="shopimg">
                  <img class="img-responsive" src="/style/img/shops/052.png"/>
                </div>
                <div class="shop-description">
                  8-12 %
                </div>
